...
if __name__ == "__main__":
    ...
    # assert os.path.exists(os.path.join(args.input_dir, 'done'))
    assert os.path.exists(os.path.join(args.input_dir, 'IID_best.pkl'))  # IID_best is produced by train.py
